...
def load_Flights(dataset):
    train_data_file = os.path.join('datasets/Flights', dataset, 'TRAIN_data.npy')
    train_labels_file = os.path.join('datasets/Flights', dataset, 'TRAIN_labels.npy')
    test_data_file = os.path.join('datasets/Flights', dataset, 'TEST_data.npy')
    test_labels_file = os.path.join('datasets/Flights', dataset, 'TEST_labels.npy')
